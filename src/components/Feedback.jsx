...
<div className="bg-white py-6 sm:py-8 lg:py-12">
  <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
    ...
    <div className="mb-10 md:mb-16">
      ...
      <p className="mx-auto max-w-screen-md text-center text-gray-500 md:text-lg">enter text here.</p>
    </div>
                    {/* text - end */}
    ...
    <form className="mx-auto grid max-w-screen-md gap-4 sm:grid-cols-2">
      ...
      <div className="sm:col-span-2">
        <label htmlFor="company" className="mb-2 inline-block text-sm text-gray-800 sm:text-base">Company</label>
      ...
      <div className="sm:col-span-2">
        <label fhtmlFor="message" className="mb-2 inline-block text-sm text-gray-800 sm:text-base">Message*</label>
